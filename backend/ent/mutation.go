...
func (m *UserMutation) SetName(i int) {
	m.name = &i
	m.addname = nil
}

// Name returns the name value in the mutation.
func (m *UserMutation) Name() (r int, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
func (m *UserMutation) OldName(ctx context.Context) (v int, err error) {
...
func (m *UserMutation) AddName(i int) {
	if m.addname != nil {
		*m.addname += i
	} else {
		m.addname = &i
...
func (m *UserMutation) AddedName() (r int, exists bool) {
	v := m.addname
	if v == nil {
		return
	}
